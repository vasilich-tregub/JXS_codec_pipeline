...
typedef enum cmdline_opt_app_e cmdline_opt_app_t;
enum cmdline_opt_app_e
{
	CMDLINE_OPT_ENCODER = 0,
	CMDLINE_OPT_DECODER,
};

typedef struct cmdline_options_t cmdline_options_t;
struct cmdline_options_t
{
	char xs_config_string[1025];
	int width;
	int height;
	int depth;
	int sequence_first;
